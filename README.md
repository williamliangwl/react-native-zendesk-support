...
* **true** _(default)_ – Shows contact support option in empty results & in nevigation bar on iOS
* **false** – Hides contact support option in empty results & in nevigation bar on iOS
